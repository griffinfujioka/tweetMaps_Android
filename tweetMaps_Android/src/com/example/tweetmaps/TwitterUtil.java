...
public final class TwitterUtil {
    ...
    public TwitterUtil() {
        ...
        configurationBuilder.setOAuthConsumerKey(ConstantValues.TWITTER_CONSUMER_KEY.toString());
        configurationBuilder.setOAuthConsumerSecret(ConstantValues.TWITTER_CONSUMER_SECRET.toString());
